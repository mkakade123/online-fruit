                                ...
                                <?php
                                    ...
                                    while($myrow = mysqli_fetch_assoc($myresult)){
                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    <div class="p-2">
                                                    <img src="/OnlinefruitDelivery/img/fruit-'.$fruitId. '.jpg" alt="" width="70" class="img-fluid rounded shadow-sm">
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        <h5 class="mb-0"> '.$fruitName. '</h5><span class="text-muted font-weight-normal font-italic d-block">Rs. ' .$fruitPrice. '/-</span>
                                                    </div>
                                                    </div>
                                                </th>
